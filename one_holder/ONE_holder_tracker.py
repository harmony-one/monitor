...
if __name__ == "__main__":
    ...
    addr_dir = "/home/ubuntu/jupyter/harmony-log-analysis/projects/ONE_holder/address"
...
#     df.to_html(path.join(html_dir, html_name))
    ...
    df.sort_values(by = ['balance'], ascending = False, inplace = True)
    with open(path.join(data, 'one_holder.html'), 'w', encoding = 'utf-8') as f:
        f.write(template.render(one_holder = df))
    print(f'-- Output HTML --')
